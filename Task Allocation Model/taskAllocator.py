...
class TaskAllocator:
    ...
    def __init__(self):        
        ...
        task2 = Task(2,"Task2",1,Priority.MEDIUM,[],(51.513056,-0.117352),TaskType.WORK,InOut.OUT)
        task3 = Task(3,"Task3",0.5,Priority.HIGH,[1],(51.513056,-0.117352),TaskType.UNIVERSITY,InOut.IN)
        task4 = Task(4,"Task4",2.5,Priority.HIGH,[1,3],(51.513056,-0.117352),TaskType.FITNESS,InOut.OUT)
        task5 = Task(5,"Task5",2,Priority.MEDIUM,[],(51.513056,-0.117352),TaskType.COOKING,InOut.IN)
        task6 = Task(6,"Task6",1,Priority.HIGH,[],(51.513056,-0.117352),TaskType.SOCIAL,InOut.OUT)
        task7 = Task(7,"Task7",1.5,Priority.MEDIUM,[],(51.513056,-0.117352),TaskType.MISCELLANEOUS,InOut.OUT)
        task8 = Task(8,"Task8",1,Priority.MEDIUM,[7],(51.513056,-0.117352),TaskType.UNIVERSITY,InOut.IN)
        task9 = Task(9,"Task9",1,Priority.MEDIUM,[],(51.513056,-0.117352),TaskType.UNIVERSITY,InOut.OUT)
        task10 = Task(10,"Task10",10,Priority.LOW,[],(51.513056,-0.117352),TaskType.WORK,InOut.IN)
        ...
        self.sortTasksByPriority(taskList)
    
    def getTaskIDs(taskList):
        taskIDs = []
        for task in taskList:
            taskIDs.append(task.getID())
        return taskIDs

    def arePriorTasksCompleted(task, completedTasks):
        for priorTask in task.getPriorTasks():
            if not priorTask in completedTasks.getTaskIDs():
                return False
        return True

    def sortTasksByPriority(self,taskList):
        for task in taskList:
